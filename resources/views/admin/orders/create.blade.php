    ...
    <div class="card-body" data-aos="fade-up">
        <form class="my-3" action="{{ route('admins.services.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="price_after" class="form-control" value="{{ old('price_after') }}">
            </div>

            <div class="form-group">
                <label for="">{{ __('Price Before') }}</label>
                <input type="number" name="price_before" class="form-control" value="{{ old('price_before') }}">
            </div>
